...
public class ScenarioRouteDefinitionRecord extends UpdatableRecordImpl<ScenarioRouteDefinitionRecord> implements Record4<String, JSONB, JSONB, UUID> {
    ...
    @Override
    public Row4<String, JSONB, JSONB, UUID> valuesRow() {
    ...
    @Override
    public ScenarioRouteDefinitionRecord value4(UUID value) {
        setFirstActionId(value);
        return this;
    }

    @Override
    public ScenarioRouteDefinitionRecord values(String value1, JSONB value2, JSONB value3, UUID value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScenarioRouteDefinitionRecord(String scenarioName, JSONB routeSource, JSONB matcher, UUID firstActionId) {
        super(ScenarioRouteDefinition.SCENARIO_ROUTE_DEFINITION);
