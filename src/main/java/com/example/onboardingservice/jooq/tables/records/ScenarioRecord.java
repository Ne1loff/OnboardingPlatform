...
public class ScenarioRecord extends UpdatableRecordImpl<ScenarioRecord> implements Record5<UUID, String, Integer, UUID, Boolean> {
    ...
    @Override
    public Row5<UUID, String, Integer, UUID, Boolean> valuesRow() {
    ...
    @Override
    public ScenarioRecord values(UUID value1, String value2, Integer value3, UUID value4, Boolean value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScenarioRecord(UUID id, String scenarioName, Integer chatId, UUID currentActionId, Boolean isActive) {
        super(Scenario.SCENARIO);
